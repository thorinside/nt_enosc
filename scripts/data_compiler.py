...
def write_header_file(class_name, file, data):
    file.write("#include \"./enosc/lib/easiglib/numtypes.hh\"\n")
    file.write("#include \"./enosc/lib/easiglib/buffer.hh\"\n\n")
...
def compile(file_name, class_name, data, output_dir="."):
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    header_path = os.path.join(output_dir, file_name + ".hh")
    implem_path = os.path.join(output_dir, file_name + ".cc")
    with open(header_path, "w") as header_file:
        write_header_file(class_name, header_file, data)
    with open(implem_path, "w") as implem_file:
