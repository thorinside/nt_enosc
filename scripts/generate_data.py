...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate data files for EnOSC.')
    parser.add_argument('--output-dir', type=str, default='.', help='The directory to write the output files to.')
    args = parser.parse_args()
    compile("data", "Data", data, output_dir=args.output_dir)
